...
try:
    ...
    class ChatCompletionMessageFunctionToolCallParam:
        """Placeholder for missing ChatCompletionMessageFunctionToolCallParam type"""
        pass
    ...
    def items_to_messages(
        ...
        for item in items:
            ...
            # 4) function/file-search calls => attach to assistant
                ...
                # FIXED: Create as dictionary instead of calling constructor
                new_tool_call = {
                    "id": file_search["id"],
                    "type": "function",
                    "function": {

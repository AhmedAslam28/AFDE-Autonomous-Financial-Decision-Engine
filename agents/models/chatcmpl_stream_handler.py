...
try:
    ...
    class Content:
        ...
        def __init__(self, text="", type="reasoning_text"):
            self.text = text
            self.type = type
...
# Handle missing ResponseReasoningTextDeltaEvent
try:
    ...
    class ResponseReasoningTextDeltaEvent:
        """Placeholder for missing ResponseReasoningTextDeltaEvent type"""
        def __init__(self, **kwargs):
            for key, value in kwargs.items():
                setattr(self, key, value)

# Handle missing ResponseReasoningTextDoneEvent
try:
    ...
    class ResponseReasoningTextDoneEvent:
        """Placeholder for missing ResponseReasoningTextDoneEvent type"""
        def __init__(self, **kwargs):
            for key, value in kwargs.items():
                setattr(self, key, value)
